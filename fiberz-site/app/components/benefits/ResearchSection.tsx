    ...
    <section className="py-12 lg:py-16 bg-white">
      <div className="max-w-content mx-auto px-6 sm:px-8 lg:px-12">
        <div className="mb-12">
          ...
          <p className="mt-4 text-gray-text text-sm max-w-lg leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            {researchPoints.map((point) => (
              <div
                key={point.title}
                className="border border-cream-dark rounded-xl p-6"
              >
                <h4 className="font-semibold text-primary mb-2">{point.title}</h4>
                <p className="text-gray-text text-sm leading-relaxed">{point.description}</p>
              </div>
            ))}
          </div>
