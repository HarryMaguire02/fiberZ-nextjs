...
import { STATS_VALUES } from '@/app/lib/productData';
...
export default async function ScientificallyProvenStats() {
  const t = await getTranslations('Product');
  const stats = (t.raw('stats') as StatItem[]).map((stat, i) => ({
    ...stat,
