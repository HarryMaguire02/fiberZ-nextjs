...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/research/resistant-dextrin' },
  ...
  openGraph: {
    ...
    type: 'article',
    url: '/research/resistant-dextrin',
  },
};
...
export default function ResistantDextrinArticle() {
  return (
    <>
      <script
        ...
        <div className="max-w-3xl mx-auto px-6 sm:px-8 lg:px-12 py-14 lg:py-20 font-roboto text-body">
          ...
          <div className="research-prose space-y-6 leading-relaxed">
            ...
            <div className="my-8">
              ...
              {/* Mobile: single column, Desktop: 2 columns read left→right, top→bottom */}
              <div className="flex flex-col items-center gap-0">

                {/* Row 1: External Factors → Dysbiosis */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                  <div className="flex flex-col items-center gap-0">
                    ...
                    {/* Arrow: visible on mobile between stacked items */}
                ...
                {/* Arrow between rows on desktop, reads as → on the flow */}
                <div className="text-2xl py-1" style={{ color: '#D97A1A' }}>{'\u2B07'}</div>

                {/* Row 2: Intestinal Dysfunction → Metabolic Diseases */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                  <div className="flex flex-col items-center gap-0">
                    <div className="rounded-xl p-4 text-white w-full" style={{ background: '#E8861C' }}>
                ...
                {/* Row 3: Metabolic Diseases → Management Strategies */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                  <div className="flex flex-col items-center gap-0">
                    <div className="rounded-xl p-4 text-white w-full" style={{ background: '#E8861C' }}>
                ...
                {/* Row 4: Restored Gut Homeostasis (centered, spans full width) */}
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="font-lato">
                  <tr className="border-b border-brand/20">
                    ...
                    <td className="text-right py-2 px-4">1193 kJ / 287 kcal</td>
                    <td className="text-right py-2 pl-4">48 kJ / 11 kcal</td>
                  </tr>
                  <tr className="border-b border-brand/20">
                    <td className="py-2 pr-4">Fat</td>
                    <td className="text-right py-2 px-4">0.6g</td>
                    <td className="text-right py-2 pl-4">0.02g</td>
                  </tr>
                  <tr className="border-b border-brand/20">
                    <td className="py-2 pr-4 pl-4 text-body/70">of which saturates</td>
                    <td className="text-right py-2 px-4">0.2g</td>
                    <td className="text-right py-2 pl-4">0.008g</td>
                  </tr>
                  <tr className="border-b border-brand/20">
                    <td className="py-2 pr-4">Carbohydrate</td>
                    <td className="text-right py-2 px-4">44g</td>
                    <td className="text-right py-2 pl-4">1.8g</td>
                  </tr>
                  <tr className="border-b border-brand/20">
                    <td className="py-2 pr-4 pl-4 text-body/70">of which sugars</td>
                    <td className="text-right py-2 px-4">3.4g</td>
                    <td className="text-right py-2 pl-4">0.1g</td>
                  </tr>
                  <tr className="border-b border-brand/20">
                    <td className="py-2 pr-4">Fiber</td>
                    <td className="text-right py-2 px-4">51g</td>
                    <td className="text-right py-2 pl-4">2.1g</td>
                  </tr>
                  <tr className="border-b border-brand/20">
                    <td className="py-2 pr-4">Protein</td>
                    <td className="text-right py-2 px-4">0.6g</td>
                    <td className="text-right py-2 pl-4">0.02g</td>
                  </tr>
                  <tr>
                    <td className="py-2 pr-4">Salt</td>
                    <td className="text-right py-2 px-4">&lt; 0.01g</td>
                    <td className="text-right py-2 pl-4">&lt; 0.0004g</td>
                  </tr>
                </tbody>
              </table>
            </div>
